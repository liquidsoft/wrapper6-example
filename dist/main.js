...
},{"./reactive-map":58,"es6-map":42,"es6-symbol":48}],55:[function(require,module,exports){
"use strict";
...
},{"./application":54,"./module":56,"./query-object":57,"./reactive-map":58}],56:[function(require,module,exports){
"use strict";
...
var _bodyText = require("./modules/body-text");

var _bodyText2 = _interopRequireDefault(_bodyText);

var _eventLogger = require("./modules/event-logger");
...
var app = window.app = new _wrapper.Application({ bodyText: "Hello, this is an example" }); /*
                                                                                            Dependecies
                                                                                             */

app.use("bodyText", _bodyText2.default); // Namespaced module
app.use(_eventLogger2.default); // Anonymous module

app.boot();

},{"./modules/body-text":60,"./modules/event-logger":61,"wrapper6":55}],60:[function(require,module,exports){
"use strict";
...
var BodyTextModule = function (_Module) {
    _inherits(BodyTextModule, _Module);

    function BodyTextModule() {
        _classCallCheck(this, BodyTextModule);

        return _possibleConstructorReturn(this, (BodyTextModule.__proto__ || Object.getPrototypeOf(BodyTextModule)).apply(this, arguments));
    }

    _createClass(BodyTextModule, [{
        key: "boot",
        value: function boot() {
    ...
    return BodyTextModule;
}(_wrapper.Module);

exports.default = BodyTextModule;

},{"wrapper6":55}],61:[function(require,module,exports){
"use strict";
...
var EventLoggerModule = function (_Module) {
    _inherits(EventLoggerModule, _Module);

    function EventLoggerModule() {
        _classCallCheck(this, EventLoggerModule);

        return _possibleConstructorReturn(this, (EventLoggerModule.__proto__ || Object.getPrototypeOf(EventLoggerModule)).apply(this, arguments));
    }

    _createClass(EventLoggerModule, [{
        key: "boot",
        value: function boot() {
...
exports.default = EventLoggerModule;
